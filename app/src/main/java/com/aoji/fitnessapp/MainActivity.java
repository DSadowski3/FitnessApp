...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RelativeLayout yogaBtn = (RelativeLayout) findViewById(R.id.yougaBtn);
        RelativeLayout cardioBtn = (RelativeLayout) findViewById(R.id.cardioBtn);

        weightBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadDeatilActivity(MainActivity.EXERCISE_WEIGHTS);
        ...
        yogaBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadDeatilActivity(MainActivity.EXERCISE_YOGA);
        ...
        cardioBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadDeatilActivity(MainActivity.EXERCISE_CARDIO);

            }
        });
    }

    private void loadDeatilActivity(String exerciseTitle){
